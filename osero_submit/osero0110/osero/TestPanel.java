...
public class TestPanel extends JPanel  implements Serializable{
    ...
    public void komasuu(Graphics g){
    	g.setColor(Color.RED);
    	g.fillRect(250, 25, 100, 50);
    	g.fillRect(250, 525, 100, 50);
    	g.setColor(Color.BLACK);
    	g.drawRect(250, 25, 100, 50);
    	g.drawRect(250, 525, 100, 50);
    	int blackScore = 0;
        int whiteScore = 0;
        for(int i = 0; i < 8; i++){
            for(int j = 0; j < 8; j++){
        ...
        g.setFont(font1);
        g.drawString("BLACK", 250, 25);
        g.drawString(blackScorestr, 255, 55);
        g.setColor(Color.WHITE);
        g.drawString(whiteScorestr, 255, 555);
        g.setColor(Color.BLACK);
        g.drawString("WHITE", 250, 525);
